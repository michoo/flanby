...
def after_start():
    fontList = ["3-d", "3x5", "5lineoblique", "acrobatic", "alligator", "alligator2", "alphabet", "avatar",
                ...
                "cybermedium", "cybersmall", "diamond", "digital", "doom", "dotmatrix", "drpepper",
                ...
                "rowancap", "rozzo", "runic", "sblood", "script", "serifcap", "shadow", "short", "slant",
